                        ...
                        >
                          ...
                          <td className="px-3 py-2">
                            <div className="flex items-center gap-1.5">
                              <span className="text-[10px] font-mono text-red-400 inline-flex items-center gap-1">{sus}<svg width="8" height="8" viewBox="0 0 8 8"><circle cx="4" cy="4" r="4" fill="#ef4444"/></svg></span>
                              <span className="text-slate-700">/</span>
                              <span className="text-[10px] font-mono text-emerald-400 inline-flex items-center gap-1">{saf}<svg width="8" height="8" viewBox="0 0 8 8"><circle cx="4" cy="4" r="4" fill="#10b981"/></svg></span>
                            </div>
                          </td>
