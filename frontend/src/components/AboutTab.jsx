    ...
    <div className="space-y-5 animate-[fadeIn_0.4s_ease]">
      ...
      <div className="rounded-2xl border border-white/6 bg-[#0a1628]/80 p-6">
        ...
        <div className="relative">
          <div className="absolute left-[23px] top-0 bottom-0 w-px bg-cyan-500/25" />
      ...
      {/* ── author ── */}
      <div className="rounded-2xl border border-white/6 bg-cyan-500/5 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-full bg-cyan-500/20 border border-white/10 flex items-center justify-center font-bold text-sm text-cyan-400">
              RL
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            <a href="https://github.com/Hamilas" target="_blank" rel="noreferrer"
              ...
              <Github size={13} /> github.com/Hamilas
            </a>
            <a href="https://www.linkedin.com/in/lassoued-rayen/" target="_blank" rel="noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 border border-white/8 text-slate-400 hover:text-slate-200 hover:bg-white/8 transition-all text-xs">
